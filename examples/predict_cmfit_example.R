...
timetoevent <- predict(sim.morts.fit, t = seq(1,365,3), type = "timetoevent", CI = TRUE, nreps = 1e2)
with(timetoevent, {
  plot(t, fit, type = "l", lwd = 2,  main = "expected time to event", ylim = c(100,365), ylab = "days")
  lines(t, CI[1,], lty = 3)
  lines(t, CI[2,], lty = 3)
})
