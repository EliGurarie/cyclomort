...
Users can also call `predict.cmfit` to estimate the expected time to death for any individual at any given time. *Note, this procedure takes a ***very*** long time even with relatively few samples. We are working on this!* 
