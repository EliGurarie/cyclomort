...
#' 
#' Details of the underlying model, motivation, and examples of implementation on mortality data are in the Gurarie et al. (\emph{in press}). An active development version is on GitHub at \url{https://github.com/EliGurarie/cyclomort}. The vignette provides several examples of the functionality of the package.
#' 
#' @keywords internal
