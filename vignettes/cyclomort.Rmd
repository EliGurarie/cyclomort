...
plot(seq(-6, 6, .01/pi), dwrpMultiCauchy(seq(-pi*6, pi * 6, .01), A = 1, mus = c(-1,1), rhos = c(0.7,0.5), weights = 0.7), type = "l", xlab = "x-value (in terms of pi)", ylab = "Probability", main = "peaks = c(-1,1), rhos = c(0.7,0.5), weights = c(0.7,0.3)")
```

```{r, fig.width = 7, fig.align = "center", echo = FALSE}
plot(seq(-6, 6, .01/pi), dwrpMultiCauchy(seq(-pi*6, pi * 6, .01), A = 1, mus = c(-1, 1, 3), rhos = c(0.4, 0.9, 0.6), weights = c(0.4,0.3)), type = "l", xlab = "x-value (in terms of pi)", ylab = "Probability", main = "peaks = c(-1,1,3), rhos = c(0.4,0.9,0.6), weights = c(0.4,0.3,0.3)")
```
